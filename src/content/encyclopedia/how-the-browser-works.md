...
![Critical rendering path: DOM + CSSOM → Render Tree → Layout → Paint → Composite](/images/critical-rendering-path.svg)
...
![JavaScript event loop: call stack, microtask queue, and task queue](/images/event-loop.svg)
