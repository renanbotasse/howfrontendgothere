...
![HTTP/1.1 vs HTTP/2: multiple connections vs multiplexed streams](/images/http1-vs-http2.svg)
...
![HTTP/2 over TCP vs HTTP/3 over QUIC: head-of-line blocking comparison](/images/http2-vs-http3.svg)
