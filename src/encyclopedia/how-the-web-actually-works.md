...
> 📸 **IMAGEM AQUI** — Abra esta URL, salve a imagem e faça upload:
> https://en.wikipedia.org/wiki/Internet_protocol_suite#/media/File:IP_stack_connections.svg
> (diagrama das 4 camadas TCP/IP: Application, Transport, Internet, Network Access)
...
> (role a página até achar o diagrama "What is a DNS resolver?" — mostra o fluxo browser → resolver → root → TLD → authoritative)
...
> (role até o diagrama "HTTP as an application layer protocol" — mostra request/response entre client e server)
